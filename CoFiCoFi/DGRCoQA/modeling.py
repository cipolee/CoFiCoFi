...
class AlbertForRetrieverOnlyPositivePassage(AlbertPreTrainedModel):
    ...
    def forward(self, query_input_ids=None, query_attention_mask=None, query_token_type_ids=None, 
                passage_input_ids=None, passage_attention_mask=None, passage_token_type_ids=None, 
                retrieval_label=None, query_rep=None, passage_rep=None, previous_step=None,revelence_passage=None):
        outputs = ()
        ...
        if query_input_ids is not None:
            ...
            if revelence_passage is not None:
                ...
                D_weight= F.softmax(self.attention_D(query_rep).squeeze(1),dim=-1)#xbli change because D_weight= F.softmax(self.attention_D(query_rep).squeeze(1))
...
# GNN embedding
        # xbli torch.float精度16与32冲突 1,node_embedding已经是32 2.关掉apex
        # pdb.set_trace()
