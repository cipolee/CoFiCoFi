...
######################yongqi
            ...
            if random.random()>0.9:
                print('Explorer_GAT_logits_loss: {}'.format(loss))
...
#########################################################################DQI
        ...
        if(len(history_q_current_q_list)>=2):
            for i in range(len(history_q_current_q_list)-1):
                ...
                # bug 2022/4/15改正。
                query_example = RetrieverInputExample(guid=0, text_a=current_q+'[SEP]'+history_q_current_q_list[i]+'[SEP]'+predicted_question_answerspans[qids[0]])
                query_feature = retriever_convert_example_to_feature(query_example, retriever_tokenizer, 
                                                                     max_length=250)
...
parser.add_argument("--blocks_path", default="/home/share/liyongqi/data_dir/CODQA/ORQUAC/all_blocks.txt", type=str, required=False,
                    help="all blocks text")
parser.add_argument("--blocks_link_path", default="/home/share/liyongqi/data_dir/CODQA/ORQUAC/all_blocks.txt", type=str, required=False,
                    help="all blocks text")
...
#              "/home/xbli/orconvqa/output/tfidf_rocketv2_us_att/checkpoint-31527-weak_31527_c3/retriever", force_download=True)

model.retriever = retriever_model_class.from_pretrained(
             "/home/xbli/orconvqa/output/tfidf_rocketv2_us_att/checkpoint-30000/retriever", force_download=True)
...
model.reader = reader_model_class.from_pretrained(
    "/home/xbli/orconvqa/output/tfidf_rocketv2_us_att/checkpoint-31527-weak_31527_c3/reader", force_download=True)


# model.explorer=Explorer_GAT.from_pretrained(args.retrieve_checkpoint, force_download=True)
model.explorer=Explorer_GAT.from_pretrained('/home/xbli/orconvqa/output/tfidf_rocketv2_us_att/checkpoint-30000/retriever', force_download=True)
...
with open('/home/xbli/orconvqa/DGRCoQA-main/data/block_link_dict.pkl', 'rb') as f:
...
# with open('/home/xbli/orconvqa/DGRCoQA-main/data/444f1/multi_test-15000.trec','r') as f:
# with open('/home/xbli/orconvqa/DGRCoQA-main/data/444f1/multi_test-15000.trec','r') as f:
with open('/home/xbli/orconvqa/DGRCoQA-main/data/441f1/multi_test_task.trec','r') as f:
    for line in tqdm(f.readlines()):
        qid=line.split(" ")[0]
        did=passage_ids[int(line.split(" ")[2])]
        score=line.split(" ")[4]
...
# with open('/home/xbli/orconvqa/DGRCoQA-main/data/444f1/multi_devtask-15000.trec','r') as f:
with open('/home/xbli/orconvqa/DGRCoQA-main/data/441f1/multi_dev_task.trec','r') as f:
    for line in tqdm(f.readlines()):
        qid=line.split(" ")[0]
        did=passage_ids[int(line.split(" ")[2])]
        score=line.split(" ")[4]
        ...
        DR_Result[qid][0].append(did)
        DR_Result[qid][1].append(int(score))
# with open('/home/xbli/orconvqa/DGRCoQA-main/data/444f1/multi_train_task-15000.trec','r') as f:
with open('/home/xbli/orconvqa/DGRCoQA-main/data/441f1/multi_train_task.trec','r') as f:
    for line in tqdm(f.readlines()):
        qid=line.split(" ")[0]
        did=passage_ids[int(line.split(" ")[2])]
        score=line.split(" ")[4]
...
# with open('/home/xbli/orconvqa/DGRCoQA-main/data/444f1/final_predictions_test.json', 'r') as f:
with open('/home/xbli/orconvqa/DGRCoQA-main/data/441f1/final_predictions_test.json', 'r') as f:
    for line in tqdm(f.readlines()):
        line= json.loads(line.strip())
...
# with open('/home/xbli/orconvqa/DGRCoQA-main/data/444f1/instance_predictions_test.json', 'r') as f:
with open('/home/xbli/orconvqa/DGRCoQA-main/data/441f1/instance_predictions_test.json', 'r') as f:
    lines=json.load(f)
    for key in lines:
...
# result = evaluate(args, model, retriever_tokenizer,
#           reader_tokenizer, prefix='test') 
### 搞了半天老是先evaluate，原来是这里出了问题，2022、4、15
# # In[10]:

# all_num,positive_num =0,[0]
# if args.do_test and args.local_rank in [-1, 0]:    
#     if args.do_eval:
#         best_global_step = best_metrics['global_step'] 
#     else:
# #         # for i in [35000,40000,50000,55000,60000,63053]:
# #         # best_global_step = args.best_global_step
# #         # for i in [30000,31527]:
# #         # for i in ['63053-rv2-base-explorer_1rt_rv','63053-rv2-weak-reader-explorer','30000']:
# #         # for i in ['30000-base-copy-from-base','30000-base-copy-from-rv2','30000-weak-copy-from-c3rt']:
# #         # for i in ['B','C','A']:
#         for i in [30000]:
#         # for i in range(3):
...
#         ########################################yongqi
#             # model.explorer=Explorer_GAT.from_pretrained("/home/share/liyongqi/data_dir/CODQA/ORQUAC/pipeline_checkpoint/checkpoint-4500/home/xbli/private/xbli/orconvqa/DGRCoQA-main/output/DGRCoQA/checkpoint-45000/retriever", force_download=True)
#             model.explorer=Explorer_GAT.from_pretrained(args.retrieve_checkpoint, force_download=True)
...
#                 args.output_dir, 'predictions', 'test_metrics_30000_442_{}.json'.format(i))
...
#             # pdb.set_trace()
#             test_metrics_file = os.path.join(
#                 args.output_dir, 'predictions', 'test_metrics_{}.json'.format(i))
#             with open(test_metrics_file, 'w') as fout:
#                 json.dump(result, fout)