...
######################yongqi
            ...
            # loss =  retriever_loss
######################xbli
            loss = retriever_loss + Explorer_GAT_logits_loss + qa_loss
            if args.n_gpu > 1:
...
#######################yongqi
            ...
            if random.random()>0.9:
                logging.info('retriever_loss:{},qa_loss:{} , rerank_loss:{} ,reader_loss:{},GRR_loss:{}'.format(retriever_loss,qa_loss,rerank_loss,
                reader_loss,Explorer_GAT_logits_loss))
            # tr_loss += loss.item()
...
with open('/home/xbli/orconvqa/DGRCoQA-main/data/convdrtrain/multi_train_task.trec','r') as f:
    for line in tqdm(f.readlines()):
        qid=line.split(" ")[0]
        did=passage_ids[int(line.split(" ")[2])]
        score=line.split(" ")[4]
        ...
        DR_Result[qid][0].append(did)
        DR_Result[qid][1].append(int(score))
with open('/home/xbli/orconvqa/DGRCoQA-main/data/convdrtrain/multi_dev_task.trec','r') as f:
    for line in tqdm(f.readlines()):
        qid=line.split(" ")[0]
        did=passage_ids[int(line.split(" ")[2])]
        score=line.split(" ")[4]
...
# with open('/home/xbli/orconvqa/DGRCoQA-main/data/final_predictions_test.json', 'r') as f:
...
# with open('/home/xbli/orconvqa/DGRCoQA-main/data/instance_predictions_test.json', 'r') as f:
...
if args.do_test and args.local_rank in [-1, 0]:    
    if args.do_eval:
        ...
        for i in ['30000-reader']:#only change retriever and reader
        # /home/xbli/orconvqa/DGRCoQA-main/
            best_global_step = i
        ...
        ########################################yongqi
            ...
            test_metrics_file = os.path.join(
                args.output_dir, 'predictions', 'test_metrics_{}_weak.json'.format(i))
