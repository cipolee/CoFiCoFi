CUDA_VISIBLE_DEVICES=2,3 python convdr_recketv2_real_online.py  --output_dir=/**/ConvDR-main/output/qafactor/retriever_5e-6reader2e-5_epoch1_freeze5000  \
...
--reader_model_name_or_path=/**/ConvDR-main/my_checkpoints/bert-base-uncased --num_negatives=9 --overwrite_output_dir --include_first_question=False\
